...
#define RACE_TASK4_AC_POINT_ARM_DISTANCE_CM       (98L)
#define RACE_TASK4_AC_POINT_ARM_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_AC_POINT_ARM_DISTANCE_CM)
#define RACE_TASK4_BD_POINT_ARM_DISTANCE_CM       (111L)
...
#define RACE_TASK4_B_EXIT_DISTANCE_CM             (200L)
#define RACE_TASK4_B_LINE_LOST_CONFIRM_CYCLES     (10U)
#define RACE_TASK4_D_BRAKE_DISTANCE_CM            (348L)
#define RACE_TASK4_A_FINISH_DISTANCE_CM           (452L)
#define RACE_TASK4_B_EXIT_DISTANCE_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_B_EXIT_DISTANCE_CM)
#define RACE_TASK4_D_BRAKE_DISTANCE_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_D_BRAKE_DISTANCE_CM)
#define RACE_TASK4_A_FINISH_DISTANCE_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_A_FINISH_DISTANCE_CM)
...
#define RACE_TASK4_D_GYRO_ENTRY_TURN_CDEG           (3400)
