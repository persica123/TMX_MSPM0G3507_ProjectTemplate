...
/* 任务四完整复制任务三控制周期；仅圈数不同。 */
#define RACE_TASK4_CONTROL_PERIOD_MS (20)
/* 第四问独立测试分支启用；该开关只开放任务四入口，不修改前三问参数。 */
#define APP_ENABLE_TASK4 (1U)
...
#define TASK3_A_FINISH_DISTANCE_CM          (460L)
...
/* ===========================================================================
 * 五、任务四：完整复制任务三，唯一区别为连续运行四圈
 * ========================================================================== */

/*
 * 本节所有数值均直接复制任务三当前实车参数，但不引用任何 TASK3_* 宏。
 * 后续修改 RACE_TASK4_* 只影响第四问，修改 TASK3_* 也不会反向影响第四问。
 */
#define TASK4_LAP_COUNT (4U)
#define TASK4_AC_HEADING_TARGET_CDEG (-3660)
#define TASK4_BD_HEADING_TARGET_CDEG (-13920)

/* 第四问专用几何、点位和逐圈 Dis 判据。 */
#define RACE_TASK4_SENSOR_TO_AXIS_MM              (175L)
#define RACE_TASK4_ARC_RADIUS_CM                  (40L)
#define RACE_TASK4_ARC_LENGTH_COUNT \
    ((31416L * RACE_TASK4_ARC_RADIUS_CM * COUNTS_PER_CM) / 10000L)
#define RACE_TASK4_ARC_EXIT_IGNORE_COUNT          (RACE_TASK4_ARC_LENGTH_COUNT / 2L)
#define RACE_TASK4_ARC_EXIT_EXTRA_COUNT \
    (((RACE_TASK4_SENSOR_TO_AXIS_MM * COUNTS_PER_CM) + 5L) / 10L)
#define RACE_TASK4_ARC_FINISH_COUNT \
    (RACE_TASK4_ARC_LENGTH_COUNT + RACE_TASK4_ARC_EXIT_EXTRA_COUNT)
#define RACE_TASK4_ARC_FORCE_STOP_EXTRA_DISTANCE_CM (27L)
#define RACE_TASK4_ARC_FORCE_STOP_COUNT \
    (RACE_TASK4_ARC_FINISH_COUNT + \
        DISTANCE_CM_TO_COUNT(RACE_TASK4_ARC_FORCE_STOP_EXTRA_DISTANCE_CM))
#define RACE_TASK4_ARC_TURN_LEFT                  (-1)
#define RACE_TASK4_ARC_TURN_RIGHT                 (1)
/* 第四问四段分别从本段起点独立计距，修改一段不会改变其他三段。 */
#define RACE_TASK4_AC_DISTANCE_CM                 (103L)
#define RACE_TASK4_BC_DISTANCE_CM                 (107L)
#define RACE_TASK4_BD_DISTANCE_CM                 (105L)
#define RACE_TASK4_DA_DISTANCE_CM                 (95L)
#define RACE_TASK4_AC_DISTANCE_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_AC_DISTANCE_CM)
#define RACE_TASK4_BC_DISTANCE_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_BC_DISTANCE_CM)
#define RACE_TASK4_BD_DISTANCE_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_BD_DISTANCE_CM)
#define RACE_TASK4_DA_DISTANCE_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_DA_DISTANCE_CM)

/* 旧名称只作兼容，全部映射到对应的四段独立距离，不再保留整圈累计值。 */
#define RACE_TASK4_AC_POINT_ARM_DISTANCE_CM       (RACE_TASK4_AC_DISTANCE_CM)
#define RACE_TASK4_AC_POINT_ARM_COUNT             (RACE_TASK4_AC_DISTANCE_COUNT)
#define RACE_TASK4_BD_POINT_ARM_DISTANCE_CM       (RACE_TASK4_BD_DISTANCE_CM)
#define RACE_TASK4_BD_POINT_ARM_COUNT             (RACE_TASK4_BD_DISTANCE_COUNT)
#define RACE_TASK4_AC_FORCE_TURN_DISTANCE_CM      (118L)
#define RACE_TASK4_AC_FORCE_TURN_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_AC_FORCE_TURN_DISTANCE_CM)
#define RACE_TASK4_B_EXIT_DISTANCE_CM             (RACE_TASK4_BC_DISTANCE_CM)
#define RACE_TASK4_B_LINE_LOST_CONFIRM_CYCLES     (10U)
#define RACE_TASK4_D_BRAKE_DISTANCE_CM            (RACE_TASK4_BD_DISTANCE_CM)
#define RACE_TASK4_A_FINISH_DISTANCE_CM           (RACE_TASK4_DA_DISTANCE_CM)
#define RACE_TASK4_B_EXIT_DISTANCE_COUNT          (RACE_TASK4_BC_DISTANCE_COUNT)
#define RACE_TASK4_D_BRAKE_DISTANCE_COUNT         (RACE_TASK4_BD_DISTANCE_COUNT)
#define RACE_TASK4_A_FINISH_DISTANCE_COUNT        (RACE_TASK4_DA_DISTANCE_COUNT)
#define RACE_TASK4_POINT_ALARM_MS                  (80U)
#define RACE_TASK4_POINT_SETTLE_MS                 (120U)
#define RACE_TASK4_TOTAL_MAX_RUN_MS                (240000U)

/* 第四问专用直线速度、轮速差 PID 和航向控制。 */
#define RACE_TASK4_LINE_MIN_PWM                    (0)
#define RACE_TASK4_LINE_MAX_PWM                    (860)
#define RACE_TASK4_STRAIGHT_BASE_PWM               (600)
#define RACE_TASK4_BD_STRAIGHT_BASE_PWM            (400)
#define RACE_TASK4_STRAIGHT_TARGET_DIFF            (0)
#define RACE_TASK4_DIFF_KP                         (22)
#define RACE_TASK4_DIFF_KD                         (6)
#define RACE_TASK4_DIFF_FF_GAIN                    (2)
#define RACE_TASK4_DIFF_CORR_MAX                   (180)
#define RACE_TASK4_LINE_ERROR_DEADBAND             (100)
#define RACE_TASK4_LINE_TURN_DIVISOR               (9)
#define RACE_TASK4_LINE_KD_DIVISOR                 (12)
#define RACE_TASK4_LINE_DERIV_LIMIT                (360)
#define RACE_TASK4_LINE_DERIV_FILTER_DIVISOR       (3)
#define RACE_TASK4_LINE_TURN_LIMIT                 (300)
#define RACE_TASK4_LINE_ERROR_FILTER_DIVISOR       (4)
#define RACE_TASK4_LINE_TURN_SLEW_STEP             (28)
#define RACE_TASK4_LINE_LOST_HOLD_CYCLES           (2)
#define RACE_TASK4_LINE_LOST_TURN_DECAY_STEP       (35)
#define RACE_TASK4_LINE_LOST_BASE_DROP             (60)
#define RACE_TASK4_LINE_LOST_TURN                  (150)
#define RACE_TASK4_STRAIGHT_GYRO_NAV_ENABLE        (1)
#define RACE_TASK4_STRAIGHT_IR_ASSIST_ENABLE       (0)
#define RACE_TASK4_STRAIGHT_IR_ASSIST_DIVISOR      (3)
#define RACE_TASK4_STRAIGHT_HEADING_CORR_DIVISOR   (8)
#define RACE_TASK4_STRAIGHT_HEADING_CORR_MAX       (140)
#define RACE_TASK4_STRAIGHT_GYRO_DAMP_DIVISOR      (1600)

/* 第四问专用弧线基础速度、轮速差和航向辅助。 */
#define RACE_TASK4_ARC_BASE_PWM                    (540)
#define RACE_TASK4_CB_ARC_ENTRY_TARGET_DIFF        (-16)
#define RACE_TASK4_CB_ARC_CRUISE_TARGET_DIFF       (-12)
#define RACE_TASK4_DA_ARC_ENTRY_TARGET_DIFF        (16)
#define RACE_TASK4_DA_ARC_CRUISE_TARGET_DIFF       (12)
#define RACE_TASK4_ARC_YAW_NAV_ENABLE              (1)
#define RACE_TASK4_ARC_YAW_CORR_DIVISOR            (220)
#define RACE_TASK4_ARC_YAW_CORR_MAX                (45)
#define RACE_TASK4_ARC_GYRO_DAMP_DIVISOR           (4400)
#define RACE_TASK4_ARC_PROFILE_WIDE_LINE_MIN_COUNT (6)
#define RACE_TASK4_ARC_PROFILE_ERROR_DEADBAND      (200)
#define RACE_TASK4_ARC_PROFILE_FILTER_DIVISOR      (2)
#define RACE_TASK4_ARC_PROFILE_ERROR_JUMP_LIMIT    (2000)
#define RACE_TASK4_ARC_PROFILE_TURN_DIVISOR        (7)
#define RACE_TASK4_ARC_PROFILE_KD_DIVISOR          (18)
#define RACE_TASK4_ARC_PROFILE_TURN_LIMIT          (220)
#define RACE_TASK4_ARC_PROFILE_TURN_SLEW_STEP      (70)
#define RACE_TASK4_ARC_PROFILE_NAV_WITH_LINE_PERCENT (35)
#define RACE_TASK4_ARC_PROFILE_LOST_TURN           (0)
#define RACE_TASK4_ARC_PROFILE_LOST_TURN_DECAY_STEP (35)

/* 第四问专用 CB 末端平滑减速，完整复制任务三。 */
#define RACE_TASK4_CB_POINT_COUNT                  (RACE_TASK4_ARC_LENGTH_COUNT)
#define RACE_TASK4_CB_EXIT_DECEL_DISTANCE_CM       (35L)
#define RACE_TASK4_CB_EXIT_DECEL_START_COUNT \
    (RACE_TASK4_CB_POINT_COUNT - \
        DISTANCE_CM_TO_COUNT(RACE_TASK4_CB_EXIT_DECEL_DISTANCE_CM))
#define RACE_TASK4_CB_EXIT_MIN_BASE_PWM            (140)
#define RACE_TASK4_CB_EXIT_LINE_FILTER_DIVISOR     (3)
#define RACE_TASK4_CB_EXIT_LINE_TURN_DIVISOR       (10)
#define RACE_TASK4_CB_EXIT_LINE_KD_DIVISOR         (30)
#define RACE_TASK4_CB_EXIT_LINE_TURN_LIMIT         (180)
#define RACE_TASK4_CB_EXIT_LINE_SLEW_STEP          (28)
#define RACE_TASK4_CB_EXIT_CONTROL_TURN_LIMIT      (150)

/* 第四问专用 CB/DA 灰度 PD；数值复制任务三实际调用的控制函数。 */
#define RACE_TASK4_CB_ERROR_SIGN                   (1)
#define RACE_TASK4_DA_ERROR_SIGN                   (-1)
#define RACE_TASK4_ARC_PWM_PERCENT                 (72)
#define RACE_TASK4_ARC_LINE_TURN_BOOST_PERCENT     (90)
#define RACE_TASK4_ARC_LINE_KP_NUM                 (10)
#define RACE_TASK4_ARC_LINE_KP_DEN                 (100)
#define RACE_TASK4_ARC_LINE_KD_NUM                 (3)
#define RACE_TASK4_ARC_LINE_KD_DEN                 (100)
#define RACE_TASK4_ARC_LINE_TURN_LIMIT             (180)
#define RACE_TASK4_ARC_CONTROL_TURN_LIMIT          (130)
#define RACE_TASK4_ARC_LINE_ERROR_DEADBAND         (250)
#define RACE_TASK4_ARC_LINE_FILTER_DIVISOR         (3)
#define RACE_TASK4_ARC_ERROR_MAX_ACTIVE_COUNT      (5)
#define RACE_TASK4_ARC_ERROR_JUMP_LIMIT            (2000)
#define RACE_TASK4_ARC_DERIV_LIMIT                 (360)
#define RACE_TASK4_ARC_DERIV_FILTER_DIVISOR        (3)
#define RACE_TASK4_ARC_TURN_SLEW_STEP              (28)
#define RACE_TASK4_ARC_LOST_TURN_DECAY_STEP        (35)
#define RACE_TASK4_DA_ENTRY_DISTANCE_CM            (30L)
#define RACE_TASK4_DA_ENTRY_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_DA_ENTRY_DISTANCE_CM)
#define RACE_TASK4_DA_ENTRY_PWM_PERCENT            (90)
#define RACE_TASK4_ARC_DECEL_START_DISTANCE_CM     (110L)
#define RACE_TASK4_ARC_DECEL_START_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_ARC_DECEL_START_DISTANCE_CM)
#define RACE_TASK4_ARC_DECEL_PWM_PERCENT           (85)
#define RACE_TASK4_DA_ENTRY_SEED_ERROR_LIMIT       (800)
#define RACE_TASK4_DA_ENTRY_SEED_TURN_LIMIT        (80)

/* 第四问专用起跑、C/B/D/A 点动作，数值完整复制任务三。 */
#define RACE_TASK4_START_ALIGN_ENABLE              (1)
#define RACE_TASK4_AC_HEADING_TARGET_CDEG          (-3300)
#define RACE_TASK4_BD_HEADING_TARGET_CDEG          (-17800 + 3520)
#define RACE_TASK4_START_RIGHT_TURN_B_PWM           (640)
#define RACE_TASK4_START_RIGHT_TURN_A_PWM           (140)
#define RACE_TASK4_START_RIGHT_TURN_SLOW_B_PWM      (300)
#define RACE_TASK4_START_RIGHT_TURN_SLOW_A_PWM      (60)
#define RACE_TASK4_C_ADVANCE_DISTANCE_CM            (6L)
#define RACE_TASK4_C_ADVANCE_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_C_ADVANCE_DISTANCE_CM)
#define RACE_TASK4_C_ADVANCE_PWM                    (340)
#define RACE_TASK4_C_ADVANCE_TIMEOUT_MS             (800U)
#define RACE_TASK4_C_TURN_B_PWM                     (-220)
#define RACE_TASK4_C_TURN_A_PWM                     (620)
#define RACE_TASK4_C_TURN_SLOW_B_PWM                (80)
#define RACE_TASK4_C_TURN_SLOW_A_PWM                (360)
#define RACE_TASK4_C_TURN_STOP_MASK                 (0x3CU)
#define RACE_TASK4_C_TURN_FORBID_MASK               (0xC3U)
#define RACE_TASK4_C_TURN_STOP_ERROR_MAX            (1500)
#define RACE_TASK4_C_TURN_LINE_STOP_MIN_YAW_CDEG    (1200)
#define RACE_TASK4_IR_TURN_STOP_MIN_COUNT            (1U)
#define RACE_TASK4_FAST_TURN_TIMEOUT_MS              (1000U)
#define RACE_TASK4_FAST_TURN_GYRO_SLOW_ENABLE        (1U)
#define RACE_TASK4_FAST_TURN_GYRO_SLOW_CDEG          (2600)
#define RACE_TASK4_TURN_YAW_STOP_TOL_CDEG            (260)
#define RACE_TASK4_TURN_CROSS_ARM_CDEG               (1000)
#define RACE_TASK4_GYRO_TURN_TIMEOUT_MS              (1200U)
#define RACE_TASK4_B_TURN_B_PWM                     (140)
#define RACE_TASK4_B_TURN_A_PWM                     (700)
#define RACE_TASK4_B_TURN_SLOW_B_PWM                (60)
#define RACE_TASK4_B_TURN_SLOW_A_PWM                (300)
/* 第四问 B 点专用较弱主动刹车；999 为原来的满力度刹车。 */
#define RACE_TASK4_B_BRAKE_B_PWM                    (800U)
#define RACE_TASK4_B_BRAKE_A_PWM                    (800U)
#define RACE_TASK4_D_TURN_B_PWM                     (620)
#define RACE_TASK4_D_TURN_A_PWM                     (20)
#define RACE_TASK4_D_TURN_SLOW_B_PWM                (360)
#define RACE_TASK4_D_TURN_SLOW_A_PWM                (80)
#define RACE_TASK4_D_POINT_BRAKE_SETTLE_MS          (1000U)
#define RACE_TASK4_D_GYRO_ENTRY_TURN_CDEG           (2800)
#define RACE_TASK4_D_HANDOFF_BRAKE_MS               (30U)
#define RACE_TASK4_A_TURN_B_PWM                     (640)
#define RACE_TASK4_A_TURN_A_PWM                     (140)
#define RACE_TASK4_A_TURN_SLOW_B_PWM                (300)
#define RACE_TASK4_A_TURN_SLOW_A_PWM                (60)
#define RACE_TASK4_TURN_SLOW_ZONE_CDEG              (1000)
#define RACE_TASK4_EXIT_TURN_PREDICT_ENABLE         (0U)
#define RACE_TASK4_EXIT_TURN_PREDICT_MS             (0)
#define RACE_TASK4_EXIT_TURN_PREDICT_ARM_CDEG       (1000)
#define RACE_TASK4_EXIT_TURN_PREDICT_MIN_GZ_MDPS    (0)

/* 第四问专用强制入弯找线保护，复制任务三。 */
#define RACE_TASK4_FORCE_ENTRY_TURN_CDEG            (3200)
#define RACE_TASK4_FORCE_FIND_LINE_DISTANCE_CM      (27L)
#define RACE_TASK4_FORCE_FIND_LINE_COUNT \
    DISTANCE_CM_TO_COUNT(RACE_TASK4_FORCE_FIND_LINE_DISTANCE_CM)
#define RACE_TASK4_FORCE_FIND_LINE_TIMEOUT_MS       (1200U)
#define RACE_TASK4_FORCE_FIND_LINE_PWM              (340)

/* 保留旧实验函数编译所需的兼容名；第四问新入口不会调用这些实验函数。 */
#define RACE_TASK4_AC_BRAKE_DISTANCE_COUNT          (RACE_TASK4_AC_POINT_ARM_COUNT)
#define RACE_TASK4_C_ENTRY_TURN_CDEG                (3000)
#define RACE_TASK4_D_ENTRY_TURN_CDEG                (3000)
#define RACE_TASK4_ENTRY_BRAKE_SETTLE_MS            (1000U)
#define RACE_TASK4_ENTRY_HANDOFF_BRAKE_MS           (30U)
#define RACE_TASK4_ENTRY_TURN_SLOW_ZONE_CDEG        (1000)
#define RACE_TASK4_C_LINE_CAPTURE_TIMEOUT_MS        (600U)
#define RACE_TASK4_C_LINE_CAPTURE_MAX_YAW_CDEG      (1000)
#define RACE_TASK4_C_LINE_CAPTURE_B_PWM             (-80)
#define RACE_TASK4_C_LINE_CAPTURE_A_PWM             (260)
#define RACE_TASK4_ENTRY_LEFT_TURN_B_PWM            (RACE_TASK4_C_TURN_B_PWM)
#define RACE_TASK4_ENTRY_LEFT_TURN_A_PWM            (RACE_TASK4_C_TURN_A_PWM)
#define RACE_TASK4_ENTRY_LEFT_TURN_SLOW_B_PWM       (RACE_TASK4_C_TURN_SLOW_B_PWM)
#define RACE_TASK4_ENTRY_LEFT_TURN_SLOW_A_PWM       (RACE_TASK4_C_TURN_SLOW_A_PWM)
#define RACE_TASK4_ENTRY_RIGHT_TURN_B_PWM           (RACE_TASK4_D_TURN_B_PWM)
#define RACE_TASK4_ENTRY_RIGHT_TURN_A_PWM           (RACE_TASK4_D_TURN_A_PWM)
#define RACE_TASK4_ENTRY_RIGHT_TURN_SLOW_B_PWM      (RACE_TASK4_D_TURN_SLOW_B_PWM)
#define RACE_TASK4_ENTRY_RIGHT_TURN_SLOW_A_PWM      (RACE_TASK4_D_TURN_SLOW_A_PWM)
#define RACE_TASK4_FORCE_LEFT_TURN_B_PWM            (RACE_TASK4_C_TURN_B_PWM)
#define RACE_TASK4_FORCE_LEFT_TURN_A_PWM            (RACE_TASK4_C_TURN_A_PWM)
#define RACE_TASK4_FORCE_LEFT_TURN_SLOW_B_PWM       (RACE_TASK4_C_TURN_SLOW_B_PWM)
#define RACE_TASK4_FORCE_LEFT_TURN_SLOW_A_PWM       (RACE_TASK4_C_TURN_SLOW_A_PWM)
#define RACE_TASK4_FORCE_RIGHT_TURN_B_PWM           (RACE_TASK4_D_TURN_B_PWM)
#define RACE_TASK4_FORCE_RIGHT_TURN_A_PWM           (RACE_TASK4_D_TURN_A_PWM)
#define RACE_TASK4_FORCE_RIGHT_TURN_SLOW_B_PWM      (RACE_TASK4_D_TURN_SLOW_B_PWM)
#define RACE_TASK4_FORCE_RIGHT_TURN_SLOW_A_PWM      (RACE_TASK4_D_TURN_SLOW_A_PWM)
#define RACE_TASK4_ADVANCE_GYRO_ENABLE              (0)
...
/* 旧第四问实验函数的距离斜坡兼容项；新入口不使用这些项。 */
#define RACE_TASK4_FIRST_AC_RAMP_START_PWM           (600)
#define RACE_TASK4_FIRST_AC_RAMP_COUNT               (0)
#define RACE_TASK4_ENTRY_DECEL_START_COUNT           (0x7FFFFFFFL)
#define RACE_TASK4_ENTRY_DECEL_RAMP_COUNT            (1L)
#define RACE_TASK4_EXIT_DECEL_START_COUNT            (0x7FFFFFFFL)
#define RACE_TASK4_EXIT_DECEL_RAMP_COUNT             (1L)
#define RACE_TASK4_BD_FORCE_TURN_COUNT               (0x7FFFFFFFL)
